    ...
    return (
        ...
        <div className="mx-auto max-w-screen-2xl px-8">
            <div className="flex items-center justify-between border-b-2 border-gray-100 py-6  md:space-x-10">
                <div className=" flex justify-start lg:w-0 lg:basis-1/4">
                    <a href="/">
                ...
                <Popover.Group as="nav" className="hidden items-center justify-around md:flex md:basis-1/2 bg-indigo-300">
